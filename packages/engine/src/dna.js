...
/**
 * Build DNA string from explicit trait selections.
 * selectedTraits: { BACKGROUND: "Blue01", SKIN: "Blue", ... } keyed by layerKey
 */
const dnaFromSelections = (layers, selectedTraits) => {
